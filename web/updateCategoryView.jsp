...
<section class="section-content">
  <div class="container">
    ...
    <main class="row mb-5">
      <form class="col-lg-6" method="post" action="updatecategory">
        ...
        <div class="mb-3">
          ...
          <input type="text"
                 class="form-control ${not empty requestScope.violations.nameViolations
                   ? 'is-invalid' : (not empty requestScope.category.getCategoryName() ? 'is-valid' : '')}"
                 id="category-name"
                 name="categoryname"
        ...
        <input type="hidden" name="id" value="${requestScope.category.getCategoryID()}">
