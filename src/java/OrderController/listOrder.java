...
public class listOrder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null || account.getRoleID() == 3) {
            ...
            int pageSize = 5;
            OrderDao orderDao = new OrderDao();
            ArrayList<Order> orders = orderDao.getOrderSuccessfull(pageNumber, pageSize);

            int totalPages = orderDao.getTotalPages(pageSize);
            ...
            request.getRequestDispatcher("orderViewManager.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null || account.getRoleID() == 3) {
            ...
            OrderDao orderDao = new OrderDao();
            List<Order> orders = orderDao.getOrderSuccessfull();
